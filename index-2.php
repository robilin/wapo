...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:52:31 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Homepage Two</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="main-slider default-banner">
        ...
        <div id="default-slider" class="carousel" data-ride="carousel" data-interval="7000" data-pause="false" data-wrap="true">
            ...
            <div class="carousel-inner" role="listbox">
               ...
               <!--Slide Item-->
              <div class="item window-size active layer-overlay overlay-dark-5" style="background-image:url(images/main-slider/3.jpg);">
              	<div class="auto-container">
                	<div class="box-inner">
                        <div class="big-title"><h2>WE PROVIDE THE BEST</h2></div>
                        <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et mattis felis. Fusce lacinia nibh vitae fermentum finibus. <br>Donec malesuada efficitur dapibus. Cras euismod nunc tellus, eget tempor purus.</p></div>
                        <div class="links-box"><a href="#" class="default-btn theme-btn">Our Services</a> &ensp; <a href="#" class="default-btn style-two theme-btn">Get Free Quote</a></div>
                    </div>
              	</div>
              </div>
        	
              <!--Slide Item-->
              <div class="item window-size layer-overlay overlay-dark-5" style="background-image:url(images/main-slider/1.jpg);">
                <div class="auto-container">
                    <div class="box-inner">
                        <div class="big-title"><h2>INDUSTRIAL SERVICE</h2></div>
                        <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et mattis felis. Fusce lacinia nibh vitae fermentum finibus. <br>Donec malesuada efficitur dapibus. Cras euismod nunc tellus, eget tempor purus.</p></div>
                        <div class="links-box"><a href="#" class="default-btn theme-btn">Our Services</a> &ensp; <a href="#" class="default-btn style-two theme-btn">Get Free Quote</a></div>
                    </div>
              	</div>
              ...
              <!--Slide Item-->
              <div class="item window-size layer-overlay overlay-dark-5" style="background-image:url(images/main-slider/2.jpg);">
                <div class="auto-container">
                    <div class="box-inner">
                        <div class="big-title"><h2>FOR OUR CLIENT</h2></div>
                        <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et mattis felis. Fusce lacinia nibh vitae fermentum finibus. <br>Donec malesuada efficitur dapibus. Cras euismod nunc tellus, eget tempor purus.</p></div>
                        <div class="links-box"><a href="#" class="default-btn theme-btn">Our Services</a> &ensp; <a href="#" class="default-btn style-two theme-btn">Get Free Quote</a></div>
                    </div>
              	</div>
    ...
    <section class="featured-three-column style-two pt-90">
    	<div class="auto-container">
            <div class="row clearfix">
    ...
    <!--Gallery Section-->
    <section class="gallery-section bg-parallax layer-overlay overlay-dark-7" data-bg-img="images/parallax/image-1.jpg">
        <div class="container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 column">
                        <figure class="image mr-5">
                            ...
                            <div class="overlay-box"><a href="images/resource/gallery-image-1.jpg" class="link lightbox-image" title="Project Photos"><span class="txt font-30"><i class="fa fa-camera"></i></span></a></div>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 column">
                        <figure class="image mr-5">
                            ...
                            <div class="overlay-box"><a href="images/resource/gallery-image-2.jpg" class="link lightbox-image" title="Project Photos"><span class="txt font-30"><i class="fa fa-camera"></i></span></a></div>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 column">
                        <figure class="image mr-5">
                            ...
                            <div class="overlay-box"><a href="images/resource/gallery-image-5.jpg" class="link lightbox-image" title="Project Photos"><span class="txt font-30"><i class="fa fa-camera"></i></span></a></div>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 column">
                        <figure class="image">
                            ...
                            <div class="overlay-box"><a href="images/resource/gallery-image-6.jpg" class="link lightbox-image" title="Project Photos"><span class="txt font-30"><i class="fa fa-camera"></i></span></a></div>
                        </figure>
                    </div>                
    ...
    <section class="get-quote pt-0">
        <div class="container p-0">
            <div class="row clearfix">
                ...
                <!--Column-->
                <div class="col-md-6 col-sm-12 col-xs-12 pt-10 p-sm-20 pb-10">
                    <br>
    ...
    <!--Team Section-->
    <section class="team-section pt-80 pb-50">
        <div class="auto-container">
            <div class="sec-title">
    	...
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 column">
                	<div class="inner-box">
                    	<div class="sec-title style-three">
                            <h3>Donâ€™t hear from us only</h3>
                        	...
                        	<div class="slider">
                                ...
                                <article class="slide-item">
                                	<div class="slide-content">
                                    	<p>â€œPellentesque a massa risus. Cras convallis finibus porta. Integer in ligula leo. Cras quis consequat nisl, at malesuada sapien. Mauris ultricies nisi eget velit bibendum, sit amet euismod mi gravida. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.â€�</p>
                                    </div>
                                ...
                                <article class="slide-item">
                                	<div class="slide-content">
                                    	<p>â€œPellentesque a massa risus. Cras convallis finibus porta. Integer in ligula leo. Cras quis consequat nisl, at malesuada sapien. Mauris ultricies nisi eget velit bibendum, sit amet euismod mi gravida. Cum sociis natoque penatibus et magnis dis parturient.â€�</p>
                                    </div>
                                    <div class="slide-info">
                                ...
                                <article class="slide-item">
                                	<div class="slide-content">
                                    	<p>â€œPellentesque a massa risus. Cras convallis finibus porta. Integer in ligula leo. Cras quis consequat nisl, at malesuada sapien. Mauris ultricies nisi eget velit bibendum, sit amet euismod mi gravida. Dis parturient montes, nascetur ridiculus mus.â€�</p>
                                    </div>
                                    <div class="slide-info">
                                    	<figure class="author-thumb img-circle"><a href="#"><img class="img-circle" src="images/resource/author-thumb-2.jpg" alt=""></a></figure>
                                        <div class="author-info">
    ...
    <!--Blog Section-->
    <section class="blog-section style-two pt-30 pb-30">
        <div class="auto-container pt-60 pb-30">
            <div class="sec-title">
                <h3>VISIT OUR LATEST POST</h3>
                <h2>DON'T MISS OUR BLOG</h2>
                <div class="line"></div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 blog-post">
                    <article class="inner-box">
                        <div class="image"><a href="blog-detail.php"><img src="images/resource/blog-image-4.jpg" alt=""></a></div>
                        <div class="post-title"><h2><a href="blog-detail.php">Etiam accumsan purus magna, et viverra neque</a></h2></div>
                        ...
                        <div class="post-desc"><p>Nullam ut mauris vitae tortor sodales efficitur. Quisque ac orci ante. Proin sit amet turpis lobortis, imperdiet nisi ut, viverra lorem.</p></div>
                        <div class="more-link"><a class="theme-btn read-more" href="blog-detail.php">READ MORE</a></div>
                    </article>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 blog-post">
                    <article class="inner-box">
                        <div class="image"><a href="blog-detail.php"><img src="images/resource/blog-image-5.jpg" alt=""></a></div>
                        <div class="post-title"><h2><a href="blog-detail.php">Etiam accumsan purus magna, et viverra neque</a></h2></div>
                        <div class="post-info"><a href="#"><span class="fa fa-user"></span>John Doe</a> &ensp;&ensp; <a href="#"><span class="fa fa-clock-o"></span>June 8, 2015</a></div>
                        <div class="post-desc"><p>Nullam ut mauris vitae tortor sodales efficitur. Quisque ac orci ante. Proin sit amet turpis lobortis, imperdiet nisi ut, viverra lorem.</p></div>
                        <div class="more-link"><a class="theme-btn read-more" href="blog-detail.php">READ MORE</a></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 blog-post">
                    <article class="inner-box">
                        <div class="image"><a href="blog-detail.php"><img src="images/resource/blog-image-6.jpg" alt=""></a></div>
                        <div class="post-title"><h2><a href="blog-detail.php">Etiam accumsan purus magna, et viverra neque</a></h2></div>
                        <div class="post-info"><a href="#"><span class="fa fa-user"></span>John Doe</a> &ensp;&ensp; <a href="#"><span class="fa fa-clock-o"></span>June 8, 2015</a></div>
                        <div class="post-desc"><p>Nullam ut mauris vitae tortor sodales efficitur. Quisque ac orci ante. Proin sit amet turpis lobortis, imperdiet nisi ut, viverra lorem.</p></div>
                        <div class="more-link"><a class="theme-btn read-more" href="blog-detail.php">READ MORE</a></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 blog-post">
                    <article class="inner-box">
                        <div class="image"><a href="blog-detail.php"><img src="images/resource/blog-image-7.jpg" alt=""></a></div>
                        <div class="post-title"><h2><a href="blog-detail.php">Etiam accumsan purus magna, et viverra neque</a></h2></div>
                        <div class="post-info"><a href="#"><span class="fa fa-user"></span>John Doe</a> &ensp;&ensp; <a href="#"><span class="fa fa-clock-o"></span>June 8, 2015</a></div>
                        <div class="post-desc"><p>Nullam ut mauris vitae tortor sodales efficitur. Quisque ac orci ante. Proin sit amet turpis lobortis, imperdiet nisi ut, viverra lorem.</p></div>
                        <div class="more-link"><a class="theme-btn read-more" href="blog-detail.php">READ MORE</a></div>
...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:52:32 GMT -->
</html>