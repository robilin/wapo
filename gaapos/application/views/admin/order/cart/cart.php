...
<!--                <input  type="text" name="price" value="--><?php //echo $item['price'] ?><!--"  onblur ="order(this);" id="--><?php //echo 'pri'.$item['rowid'] ?><!--" class="form-control">-->
                <div class="input-group">
                    ...
                    <input  type="text" name="price" value="<?php echo $item['price'] ?>"  onblur ="order(this);" id="<?php echo 'pri'.$item['rowid'] ?>" class="form-control" style="width: 100px"
            ...
            <td class="vertical-td"><?php echo $this->localization->currency($item['subtotal'])  ?></td>
