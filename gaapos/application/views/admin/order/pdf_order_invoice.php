...
<table style="padding:20px" width="100%">
    ...
    <tr>
        ...
        <td width="50%" align="right" style="padding-bottom: 35px; border-bottom:1px solid #ededed">
            <span style="font-size:30px; color:#00A7D0"><strong>CASH<?php echo $invoice_info->invoice_no ?></strong></span>
            <br/>
            <spna>Cash Date: <?php echo $this->localization->dateFormat($invoice_info->invoice_date )?></spna>
            <br/>
...
<table style="padding:20px" width="100%" border='1'>
    ...
    <tr align="center">
        ...
        <td style="border-bottom:1px solid #ededed;padding:20px">
            <?php echo $v_order->product_name.'('.$v_order->unit.')'?>
        </td>
