                                    ...
                                    <div class="box-body order-panel">
                                        ...
                                        <div id="my-tab-content" class="tab-content">
                                            ...
                                            <div class="tab-pane" id="search-product">
                                                ...
                                                <form id="addToCart" method="post" action="<?php echo base_url(); ?>admin/order/add_cart_items">

                                                    <div class="table-responsive">
                                                    <!-- Table -->
                                                    <table id="datatable" class="table table-striped table-bordered cart-buttons" style="width: 100%">
                                                        <thead><!-- Table head -->
                                                        <tr>
                                                        ...
                                                        <?php if (!empty($product)): foreach ($product as $v_product) : ?>
                                                            <tr>
                                                                <td class="col-sm-1"><input name="product_barcode[]" value="<?php echo $v_product->product_code ?>" class="child_present" type="checkbox" /></td>
                                                                <td class="highlight">
