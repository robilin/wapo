...
<html>
    <head>
        ...
        <!-- Data Table  CSS -->
        <link href="<?php echo base_url(); ?>asset/plugin/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>asset/plugin/datatables/buttons.bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>asset/plugin/datatables/fixedHeader.bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>asset/plugin/datatables/responsive.bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>asset/plugin/datatables/scroller.bootstrap.min.css" rel="stylesheet" type="text/css" />
