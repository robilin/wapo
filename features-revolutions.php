...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/features-revolutions.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:49:28 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | About Us</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <!--Page Title-->
    <section class="page-title layer-overlay overlay-dark-8" style="background-image:url(images/background/page-title-1.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Premium Revolution Slider Template</h1>                
                </div>
            </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mt-30">
            <h4 class="text-center">We have included Revolution Slider(Save $14) Package with the theme. <br>You can take a deep look from below:</h4>
          </div>
        </div>
      </div>
    </section>
    <section>
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <iframe src="http://revolution.themepunch.com/examples/" style="width: 100%; height: 2000px"></iframe>
          </div>
        </div>
      </div>
    </section>
...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/features-revolutions.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:49:52 GMT -->
</html>
