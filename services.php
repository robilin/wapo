...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/services.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:52:59 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Services One</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/parallax/image-1.jpg);">
        ...
        <!--Go Down Button-->
        <div class="go-down">
            <div class="curve scroll-to-target" data-target="#services-section"><span class="icon fa fa-arrow-down"></span></div>
        </div>
