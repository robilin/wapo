...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:52:32 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Homepage Three</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="main-slider static-banner default-banner">
        ...
        <div class="window-size layer-overlay overlay-dark-5" style="background-image:url(images/main-slider/3.jpg);">
            <div class="auto-container">
                <div class="box-inner">
                	<div class="static-content">
                      <div class="big-title"><h2>WE PROVIDE THE BEST <BR>INDUSTRIAL SERVICE</h2></div>
    ...
    <section class="services-section pt-50 pb-20">
        <div class="auto-container pb-35">
            ...
            <div class="sec-content mt-50">
                <div class="row services2 clearfix">
                    ...
                    <div class="col-md-4  col-sm-6 col-xs-12 column wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <article class="inner-box">
                            ...
                            <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et felis. Fusce lacinia nibh vitae fermentum finibus. Donec amit malesuada efficitur dapibus. Cras euismod nunc tellus.</p></div>
                            <div class="more-link">
                                <a href="#" class="read-more mr-10"><span class="fa fa-caret-right"></span> Read More </a>
                                <a href="#" class="read-more text-black"><span class="fa fa-caret-right"></span> Get Service </a>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="col-md-4  col-sm-6 col-xs-12 column wow fadeIn" data-wow-delay="900ms" data-wow-duration="1500ms">
                        <article class="inner-box">
                            <figure class="image"><a href="#"><img src="images/resource/featured-image-4.jpg" alt=""></a></figure>
                            <h2>Power & Energy</h2>
                            <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et felis. Fusce lacinia nibh vitae fermentum finibus. Donec amit malesuada efficitur dapibus. Cras euismod nunc tellus.</p></div>
                            <div class="more-link">
                                <a href="#" class="read-more mr-10"><span class="fa fa-caret-right"></span> Read More </a>
    ...
    <!--Top Services-->
    <section class="top-services pt-80 pb-40">
        <div class="auto-container">
            <div class="sec-title">
    ...
    <!--Gallery Section-->
    <section class="gallery-section bg-parallax layer-overlay overlay-dark-7 pt-90 pb-90" data-bg-img="images/parallax/image-1.jpg">
        <div class="container">
    ...
    <section class="default-two-column pb-20 pb-40">
    ...
    <section class="parallax-section pt-80 pb-80" style="background-image:url(images/parallax/image-2.jpg);">
    	<div class="auto-container">
        	<div class="text-center">
            	<h2>YOU ARE <strong>IN LOVE</strong> WITH FACTORY HUB &amp; WANT TO <strong>STAND OUT</strong></h2>
                <div class="line"></div>
                <a class="theme-btn default-btn" href="#">REACH OUT TO US</a>
                <a class="theme-btn normal-btn" href="#">BUY CARHUB NOW</a>
