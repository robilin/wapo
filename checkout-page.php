...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/checkout-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:50:43 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Chackout Page</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/parallax/image-1.jpg);">
        ...
        <!--Go Down Button-->
        <div class="go-down">
            <div class="curve scroll-to-target" data-target="#checkout-content"><span class="icon fa fa-arrow-down"></span></div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 left-checkout">
                    ...
                    <div class="sec-title style-three ship-different">
                        <h2><input type="checkbox"> ship to different address</h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 order-box">
                            <ul>
                                ...
                                <li><input type="radio"> PayPal <img src="images/resource/paypal.png" alt=""> <a href="#"><span>What is PayPal?</span></a></li>
...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/checkout-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:50:44 GMT -->
</html>
