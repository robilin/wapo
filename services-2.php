...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/services-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:50:13 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Services Two</title>
<!-- Stylesheets -->
                ...
                <div class="col-md-9 col-sm-8 col-xs-12 pull-right content-side">
                    ...
                    <section class="services-section style-two">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 column">
                                <article class="inner-box">
                                    <figure class="image"><a href="#"><img src="images/services/4.jpg" alt=""></a></figure>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 column">
                                <article class="inner-box">
                                    <figure class="image"><a href="#"><img src="images/services/5.jpg" alt=""></a></figure>
                                    <h2>Petroleum & Gas</h2> 
                                    <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et mattis felis. Fusce lacinia nibh vitae fermentum finibus. Donec malesuada efficitur dapibus. Cras euismod nunc tellus.</p></div>
                                    <div class="more-link"><a href="#" class="read-more"><span class="fa fa-caret-right"></span> More Info </a></div>
                                </article>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 column">
                                <article class="inner-box">
                                    <figure class="image"><a href="#"><img src="images/services/6.jpg" alt=""></a></figure>
                                    <h2>Power & Energy</h2>
                                    <div class="text"><p>Proin nec lacus lacus. Sed vitae consectetur est, et mattis felis. Fusce lacinia nibh vitae fermentum finibus. Donec malesuada efficitur dapibus. Cras euismod nunc tellus.</p></div>
                                    <div class="more-link"><a href="#" class="read-more"><span class="fa fa-caret-right"></span> More Info </a></div>
                                </article>
