...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/pricing-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:50:32 GMT -->
<head>
<meta charset="utf-8">
                ...
                <div class="col-md-4">
                    <div class="pricing-table mt-60">
                        <div class="pricing-header">
                            <div class="thumb">
                                <img src="images/resource/pricing-img-1.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="pricing-btn">
                            <a class="btn thm-btn bdrs-0" href="#">GET DISCOUNT</a>
                            <span class="btn thm-btn inverse pull-right p-0 m-0 bdrs-0">10%</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="pricing-table active mt-60">
                        <div class="pricing-header">
                            <div class="thumb">
                                <img src="images/resource/pricing-img-2.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="pricing-btn">
                            <a class="btn thm-btn bdrs-0" href="#">GET DISCOUNT</a>
                            <span class="btn thm-btn pull-right p-0 m-0 bdrs-0">15%</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="pricing-table mt-60">
                        <div class="pricing-header">
                            <div class="thumb">
                                <img src="images/resource/pricing-img-3.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="pricing-btn">
                            <a class="btn thm-btn bdrs-0" href="#">GET DISCOUNT</a>
                            <span class="btn thm-btn inverse pull-right p-0 m-0 bdrs-0" href="#">20%</span>
                        </div>
                    </div>
                </div>
            </div>
