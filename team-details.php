...
<!-- Mirrored from hasan.themexlab.com/category/business/factory-hub/factory-hub/team-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2016 15:52:59 GMT -->
<head>
<meta charset="utf-8">
<title>Factory Hub || Factory & Industrial Business HTML5 Responsive Template | Doctors Details Page</title>
<!-- Stylesheets -->
    ...
    <section class="page-title" style="background-image:url(images/parallax/image-1.jpg);">
        <div class="auto-container">
            ...
            <ul class="bread-crumb">
                ...
                <li><a href="#">Engineer Details</a></li>
            </ul>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8 pl-60 pl-sm-15">
              <div>
                <h3>Dr. Jeffrey Morgan</h3>
                <h5 class="text-thm">Engineers (Trainer), FRA (Mechanic Resources Association)</h5>
                <p>Reprehenderit debitis fuga esse, earum aliquid quo illum numquam necessitatibus magnam, nesciunt molestiae optio minus perspiciatis perferendis consequatur, eum inventore, quaerat temporibus a. Quam iusto nesciunt sed. Graduate School of Biomedical Sciences University of Texas Health Science Center at San Antonio.</p>
              </div>
              <div class="mt-30">
                <dl class="dl-horizontal doctor-info">
                  ...
                  <dd>
                    <ul class="list asterisk m-0">
                      <li class="mt-0">Engine Repair</li>
                      <li>Certificate II in Mechanic</li>
                    </ul>
                  </dd>
                  <br>
                  <dt>Education</dt>
                  <dd>
                    <ul class="list asterisk m-0">
                      <li class="mt-0">Certificate II in Mechanic, University of Texas, USA (1990)</li>
                      <li>Mechanic Orientation Program, St. Louis University (St. Louis, Missouri 1996)</li>
                    </ul>
                  </dd>
                  <br>
                  <dt>Experience</dt>
                  <dd>
                    <ul class="list asterisk m-0">
                        <li>15 years of Experience in Gardening and forestry.</li>
                        <li>Assisted owner and lead Engineers in the maintenance of over 25 properties.</li>
                    </ul>
                  </dd>
                  <br>
                  <dt>Profession</dt>
                  <dd>
                    <ul class="list asterisk m-0">
                      <li class="mt-0">MD Dean and Executive Vice President for Gardening Affairs</li>
                      <li>School of Gardening and Graduate School of Forestry Sciences University </li>
                      <li>of Texas Health Science Center at San Antonio</li>
                    </ul>
                  </dd>
                  <br>
                  <dt>Address</dt>
                    <dd> <i class="fa fa-map-marker text-thm"></i>&nbsp; &nbsp; BMA House, Tavistock Square, London WC1H 9JR</dd>
                  <br>
                  <dt>Phone</dt>
                    <dd><i class="fa fa-phone text-thm"></i>&nbsp; +020 7387 4499</dd>
                  <br>
                  <dt>Skype</dt>
                    <dd><i class="fa fa-skype text-thm"></i>&nbsp; yourskypeID </dd>
                  <br>
                  <dt>Email</dt>
                    <dd><i class="fa fa-envelope-o text-thm"></i>&nbsp; mail@yourdomain.com </dd>
                  <br>
                  <dt>Website</dt>
            ...
            <div class="col-sx-12 col-sm-4 col-md-4 mb-30">
              <div class="doctor-thumb">
                <img class="img-responsive" src="images/resource/doc-dtls.jpg" alt="">
              </div>
              ...
              <div class="mt-30 p-30" style="border: 12px solid #dddddd;">
                <h5 class="text-thm bottom-border mb-20">Client's Feedback</h5>
                    <!--Testimonials Slider-->
                                ...
                                <div class="slide-info">
                                    ...
                                    <div class="author-info">
                                        ...
                                        <ul class="list-inline pl-5">
                                            <li class="fa fa-star text-thm p-0"></li>
                                            <li class="fa fa-star text-thm p-0"></li>
                                            <li class="fa fa-star text-thm p-0"></li>
                                            <li class="fa fa-star text-thm p-0"></li>
                                            <li class="fa fa-star text-thm p-0"></li>
